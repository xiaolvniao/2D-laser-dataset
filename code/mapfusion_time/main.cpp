...
//        cv::imshow("Inlier Matches", img_matches_ransac);
//        cv::waitKey(0);
        return T_3x3;
...
//    imshow("img2_transform", img2_transform);
...
//    double start_all = getCurrentTime();
//    // 检测关键点和计算描述子
...
//
//    printf("the feature extract running time is %.8f\n", getCurrentTime() - start);
//
//
//
//    // 将关键点转换为 raw_data
...
//    printf("the GriT-DBSCAN running time is %.8f\n", getCurrentTime() - start);
//
//
//    //聚类结果处理
...
//    printf("the filter_clusters running time is %.8f\n", getCurrentTime() - start);
//
//    // 将聚类结果映射回来
...
//    printf("the feature match running time is %.8f\n", getCurrentTime() - start);
//
//
//    //地图融合
//    start = getCurrentTime() - start;
//    merge(image1, image2,  T);
//    printf("the map fuison running time is %.8f\n", getCurrentTime() - start);
...
//        akaze->detectAndCompute(image2, noArray(), keypoints2, descriptors2);
    ...
    double average_time1 = total_time_other / num_trials;

    printf("the all map fuison running time is %.6f\n", average_time);
    printf("the other processing running time is %.6f\n", average_time1);
    printf("the all map fuison minus other processing running time is %.6f\n", average_time-average_time1);
    system("pause");
    return 0;
}
