...
//        计算Confidence
//        double match_num =  mask.total();
//        double inliers =   countNonZero(mask);
//        std::cout << "Total Matches: " << match_num << std::endl;
//        std::cout << "Inliers Number: " << inliers << std::endl;
//        double confidence = inliers/(8+0.3*match_num);
...
//    Mat image2 = imread("..\\maps\\DM1\\DM_7.pgm", IMREAD_GRAYSCALE);
    ...
    for (int i = 0; i < num_trials; ++i)
    {
        ...
        detectKeypointsAndDescriptors(image1, keypoints1, descriptors1,1);
        detectKeypointsAndDescriptors(image2, keypoints2, descriptors2,1);
        ...
        //SIFT/SURF+BF flag=1 欧氏距
        //ORB/AKAZE+BF flag=2 汉明距
//        vector<DMatch> matches = feature_match_ByBF(descriptors1, descriptors2,0.75,1);
